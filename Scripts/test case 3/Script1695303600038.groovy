...
WebUI.doubleClick(findTestObject('Object Repository/Page_Interact with Input fields/input_Confirm text is readonly_dontwrite'))

WebUI.click(findTestObject('Object Repository/Page_Interact with Input fields/input_Confirm text is readonly_dontwrite'))

WebUI.verifyElementNotClickable(findTestObject('Object Repository/Page_Interact with Input fields/input_Confirm text is readonly_dontwrite'))
